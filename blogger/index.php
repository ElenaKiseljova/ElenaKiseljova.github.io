      ...
      <div class="page-header__wrapper">
        ...
        <nav class="page-header__navigation">
          <ul class="page-header__site-list">
            ...
            <li class="page-header__site-item">
              <a class="button" href="freelancer-1.php">База знаний</a> <!-- https://www.bloggermall.com.ua/baza_znaniy/ -->
              <ul class="page-header__sub-list">
                <li class="page-header__sub-item">
                  <a class="button" href="freelancer-1.php">Блогерам</a>
                </li>
                <li class="page-header__sub-item">
                  <a class="button" href="freelancer-1.php">Рекламодателям</a>
                </li>
                <li class="page-header__sub-item">
                  <a class="button" href="freelancer-1.php">Верное решение</a>
                </li>
                <li class="page-header__sub-item">
                  <a class="button" href="freelancer-1.php">Как эффективно работать с блогерами</a>
                </li>
              </ul>
            </li>
            <li class="page-header__site-item active">
              <a class="button" href="freelancer-1.php">Блогеры</a>
            </li>
            <li class="page-header__site-item">
              <a class="button" href="freelancer-1.php">Учетная запись</a>
            </li>
          </ul>
          <ul class="page-header__user-list">
            ...
            <li class="page-header__user-item">
              <a class="page-header__registration button" href="freelancer-1.php">Регистрация</a>
            </li>
          </ul>
        </nav>
      </div>
              ...
              <?php foreach ($rating as $step): ?>
                <li class="catalog__bloger-item">
                  ...
                  <div class="catalog__bloger-right">
                    ...
                    <a class="catalog__more button" href="freelancer-1.php">Подробнее</a>
                  </div>
                </li>
              <?php $i++; ?>
              <?php endforeach; ?>
