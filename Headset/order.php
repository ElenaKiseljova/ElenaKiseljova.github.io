...
// параметры запроса
$data = array(
  'key'             => 'a06f6328fa7d91eb8e44d7b4c05073b3', //Ваш секретный токен
...
// запрос
$curl = curl_init();
curl_setopt($curl, CURLOPT_URL, 'http://elenakiseljova.lp-crm.biz/api/addNewOrder.html');
