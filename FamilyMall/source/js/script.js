$(document).ready(function () {
 ...
 // FOCUS & BLUR
  ...
  if (url_order == -1) {
    ...
    Cookies.remove("product_id__add");
    Cookies.remove("product_comment");
  }
  ...
  function sale_add (sale, product) {
    var price = product.html();
    var final_price = parseInt(price) * 100 / (100 - sale);
  ...
  $(".offers__price-product--total-4").html(sumPrice($(".offers__price-product--4"), $(".offers__price-product")));

  // old price

  $(".offers__price-old-product").html(sale_add(50, $(".offers__price-product")));

  $(".offers__price-old-product--1").html(sale_add(15, $(".offers__price-product--1")));
  $(".offers__price-old-product--2").html(sale_add(15, $(".offers__price-product--2")));
  $(".offers__price-old-product--3").html(sale_add(15, $(".offers__price-product--3")));
  $(".offers__price-old-product--4").html(sale_add(15, $(".offers__price-product--4")));


  // *** 1 *** complect

  $("#complect-1").click(function () {
    var comment = "Дополнительный товар: " + $(".offers__price-product--1").parent().parent().siblings("h3").html();

    Cookies.set("product_comment", comment);

    var total_price = $(".offers__price-product--total-1").html();

    Cookies.set("total", total_price);

    Cookies.set("product_id__add", product_add[0]);
  ...
  $("#complect-2").click(function () {
    var comment = "Дополнительный товар: " + $(".offers__price-product--2").parent().parent().siblings("h3").html();
    ...
    Cookies.set("total", total_price);
    Cookies.set("product_id__add", product_add[1]);
  ...
  $("#complect-3").click(function () {
    var comment = "Дополнительный товар: " + $(".offers__price-product--3").parent().parent().siblings("h3").html();
    ...
    Cookies.set("total", total_price);
    Cookies.set("product_id__add", product_add[2]);
  ...
  $("#complect-4").click(function () {
    var comment = "Дополнительный товар: " + $(".offers__price-product--4").parent().parent().siblings("h3").html();

    Cookies.set("product_comment", comment);

    var total_price = $(".offers__price-product--total-4").html();

    Cookies.set("total", total_price);
    Cookies.set("product_id__add", product_add[3]);


    if (Cookies.get("single") != "4") {
      Cookies.set("single", "4");

      $(".order-section__item--5").css("display", "flex");
    }
  });
 ...
 // check test cookie
  ...
  if (Cookies.get("total")) {
    ...
    $("#prodPrice").val(Cookies.get("total"));
  }

  if (Cookies.get("product_id__add")) {
    $("#prodId_add").val(Cookies.get("product_id__add"));
  }

  if (Cookies.get("product_comment")) {
    $("#prodName").val(Cookies.get("product_comment"));
  }
