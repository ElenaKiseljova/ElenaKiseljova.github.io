      ...
      <div class="page-header__wrapper">
        ...
        <nav class="page-header__navigation navigation">
          ...
          <ul class="page-header__site-list navigation__site-list">
            ...
            <li class="page-header__site-item navigation__site-item">
              <a class="button<?php pageName($title, 'Categories'); ?>" href="categories.php">All page</a>
              ...
              <div class="navigation__sub-container">
                <ul class="navigation__sub">
                  ...
                  $pages = array(
                    ...
                    '10' => array(
                      'title' => 'Оформление заказа-1',
                      'link' => 'checkout.php',
                    ),
                    '11' => array(
                      'title' => 'Оформление заказа-2',
                      'link' => 'checkout-guest.php',
                    ),
                    '12' => array(
                      'title' => 'Коллекция',
                  ...
                  <?php while ($g < 22) : ?>
                    ...
                    <li class="navigation__sub-item">
                      <a class="button" href="<?= $pages[$g]['link']; ?>">
                        <?= $pages[$g]['title']; ?>
                      </a>
                    </li>
